...
import hust.soict.cyber.aims.screen.additem.AddBookToStoreScreen;
import hust.soict.cyber.aims.screen.additem.AddCompactDiscToStoreScreen;
import hust.soict.cyber.aims.screen.additem.AddDigitalVideoDiscToStoreScreen;
    ...
    public void initialize(){
        ...
        for (int i = 0; i < store.getItemsInStore().size(); i++){
            try{
                ...
                fxmlLoader.setLocation(getClass().getResource("/hust/soict/cyber/aims/screen/fxml/item.fxml"));
